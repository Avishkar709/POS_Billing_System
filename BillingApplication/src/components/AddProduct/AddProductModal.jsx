...
//     try {
//       if (editProduct) {
//         await axios.put(`http://localhost:8989/GoMart/product/updateProduct/${editProduct.productid}`, formData);
//         toast.success('Product edited successfully!', { autoClose: 1000 });
//       } else {
//         await axios.post('http://localhost:8989/GoMart/product/addProduct', formData);
