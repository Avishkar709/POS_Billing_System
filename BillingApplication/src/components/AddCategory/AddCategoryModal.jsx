...
//     try {
//       if (editCategory) {
//         await axios.put(`http://localhost:8989/GoMart/category/updateCategory/${editCategory.categoryid}`, formData);
//         toast.success('Category edited successfully!', { autoClose: 1000 });
//       } else {
//         await axios.post('http://localhost:8989/GoMart/category/addCategory', formData);
